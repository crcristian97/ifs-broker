      ...
      <div className="relative mx-auto w-full max-w-[1400px]">
        ...
        <div className="relative w-full">
          <h4 className="mb-7 text-center flex flex-col items-center gap-2">
            <span
              className="text-3xl sm:text-4xl md:text-5xl text-[#033163] font-regular leading-tight"
              style={{ fontFamily: 'var(--font-oxanium), sans-serif' }}
            >
              <span className="text-[#006FC4]">RESPALDO INTERNACIONAL Y</span> SOLIDEZ FINANCIERA
            </span>
            <p className="text-base sm:text-lg font-regular mt-3 text-[#033163] max-w-xl">
