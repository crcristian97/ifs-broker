  ...
  return (
    <div className="relative [perspective:1200px]">
      <div
        ...
        className="bg-gradient-to-br from-[#E5EEF5]/20 to-[#E5EEF5]/10 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 h-full flex flex-col backdrop-blur-md border border-white/40"
      >
