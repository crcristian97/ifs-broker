...
export function FeatureBar({
  ...
  const defaultFeatures: FeatureItem[] = [
    { icon: <UserKey className="h-5 w-5 shrink-0 text-[#033163]" />, title: t("personalized") },
    { icon: <Handshake className="h-5 w-5 shrink-0 text-[#033163]" />, title: t("longTerm") },
    { icon: <ShieldCheck className="h-5 w-5 shrink-0 text-[#033163]" />, title: t("international") },
  ];
